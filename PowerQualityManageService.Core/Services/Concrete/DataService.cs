...
public class DataService : IDataService
{
    ...
    public async Task<Dictionary<string, IEnumerable<object?>>?> GetResults(DateTime startDate, DateTime endDate, List<string> keys)
    {
        IEnumerable<DataSample>? samples = await _dataManagementRepository.GetDataSamples(startDate, endDate);
